...
public class EntityInit {
    ...
    public static final RegistryObject<EntityType<LunarMonstrosity>> LUNAR_MONSTROSITY = ENTITIES.register("lunar_monstrosity", () -> EntityType.Builder.<LunarMonstrosity>of(LunarMonstrosity::new, MobCategory.MONSTER).sized(1f, 2.5f).build(new ResourceLocation(EternalStarlight.MOD_ID, "lunar_monstrosity").toString()));
